        ...
        <div class="card-body p-4">
            <form id="borrowForm">
                ...
                <div class="row g-3 mb-4">
                    ...
                    <div class="col-md-4">
                        <label class="form-label fw-semibold text-dark">Preferred Time Slot / Oras</label>
                        <input type="text" name="scheduled_time" class="form-control fw-semibold" placeholder="e.g., 9:00 AM - 10:00 AM, 2:30 PM" required>
                    </div>
                    <div class="col-md-12">
