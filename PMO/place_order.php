...
document.addEventListener('DOMContentLoaded', () => {
    ...
    const reqTypeParam = urlParams.get('type');
    if (reqTypeParam) {
        const selectElem = document.getElementById('request_type');
        if (selectElem && selectElem.querySelector(`option[value="${reqTypeParam}"]`)) {
            selectElem.value = reqTypeParam;
        }
    }
